	...
	<div class="dashboard-main-wrapper">
		...
		<div class="dashboard-wrapper" style="margin-top: 5%;">
			...
			<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">DANH SÁCH NHÂN VIÊN VÀ CÁC KHÓA ĐÀO TẠO</h5>
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered first">
                                        <thead>
                                           <tr>
												<td>Mã Khóa Đào Tạo</td>
												<td>Tên Nhân Viên</td>
												<td>Khóa Đào Tạo</td>
												<td>Ngày Bắt Đầu</td>
												<td>Ngày Kết Thúc</td>
                                        ...
                                        <tbody>
                                            <c:forEach items="${employeeList }" var="employee">
												<tr>
													...
													<td>${employee.getEmployeeDTO().getEmpName() }</td>
													<td>${employee.getTrainingDTO().getTrainingName() }</td>
													<td>${employee.getTrainingEmpStartDate() }</td>
													<td>${employee.getTrainingEmpEndDate() }</td>
													<c:if test="${employee.getTrainingEmpStatus() == 1 }">
														<td>Còn Hoạt Động</td>
													</c:if>
													<c:if test="${employee.getTrainingEmpStatus() == 0 }">
														<td>Không Hoạt Động</td>
													</c:if>
													<td>${employee.getTrainingEmpResult() }</td>
												</tr>
											</c:forEach>
                                        </tbody>
                                        <tfoot>
                    ...
                    <ul class="pagination" style="float: right;	">
	                    <li class="page-item"><a class="page-link" href="<c:url value='/trang-user/ds-nhan-vien-khoa-dao-tao/${trangTruoc}'/>">Previous</a></li>
	                    <c:forEach var="soTrang" begin="1" end="${soTrang}">               	
							  <li class="page-item">
							  	<a class="page-link" href="<c:url value='/trang-user/ds-nhan-vien-khoa-dao-tao/${soTrang}'/>"> style="padding-top: 29%;" >${soTrang }</a>
							  </li>
	                    </c:forEach>
	                     <li class="page-item"><a class="page-link" href="<c:url value='/trang-user/ds-nhan-vien-khoa-dao-tao/${trangSau}'/>">Next</a></li>
                    </ul>
            <div style="margin-left: 2%;">
				<a href="<c:url value='/trang-user/ds-nhan-vien-khoa-dao-tao/?type=xlsx'/>">
				...
				<a href="<c:url value='/trang-user/ds-nhan-vien-khoa-dao-tao/?type=pdf'/>">
